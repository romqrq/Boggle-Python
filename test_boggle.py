...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_size_is_width_times_height(self):
        """
        Test is to ensure that the total size of the grid is equal to width
        *height
        """
    ...
    def test_grid_coordinates(self):
        """
        TEst to ensure that all the coordinates inside of the grid
        can be accessed
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        Ensure that each of the coodinates in the grid contains letters
        """
        grid = boggle.make_grid(2, 3)
    ...
    def test_neighbours_of_a_position(self):
        """
        Ensure thtat a position has 8 neighbours
        """
        coords = (1, 2)
